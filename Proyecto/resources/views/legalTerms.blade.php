...
@section('content')
    <div class="container mt-5">
        <h1 class="colorFuenteWebInfo1">AVISO LEGAL Y TÉRMINOS DE USO</h1>
        <p class="colorFuenteWebInfo2">En este espacio, el USUARIO, podrá encontrar toda la información relativa a los términos y condiciones legales que definen
            las relaciones entre los usuarios y nosotros como responsables de esta web. Como usuario,
        ...
        <h3 class="colorFuenteWebInfo1">CONDICIONES GENERALES DE USO</h3>
    ...
    Queda prohibido el uso de la web, con fines ilícitos o lesivos, o que, de cualquier forma, puedan causar perjuicio o impedir el normal funcionamiento del sitio web. Respecto de los contenidos de esta web, se prohíbe: Su reproducción, distribución o modificación, total o parcial, a menos que se cuente con la autorización de sus legítimos titulares; Cualquier vulneración de los derechos del prestador o de los legítimos titulares; Su utilización para fines comerciales o publicitarios.
        ...
        <h3 class="colorFuenteWebInfo1">RECLAMACIONES</h3>
        <p class="colorFuenteWebInfo2">informa que existen hojas de reclamación a disposición de usuarios y clientes. El Usuario podrá realizar reclamaciones solicitando su hoja de reclamación o remitiendo un correo electrónico a indicando su nombre y apellidos, el servicio y/o producto adquirido y exponiendo los motivos de su reclamación.
            ...
            El usuario/comprador podrá notificarnos la reclamación, bien a través de correo electrónico a: transferdavid@hotmail.com, si lo desea adjuntando el siguiente formulario de reclamación: El servicio/producto: Adquirido el día: Nombre del usuario: Domicilio del usuario: Firma del usuario (solo si se presenta en papel): Fecha: Motivo de la reclamación:</p>

        <h3 class="colorFuenteWebInfo1">PLATAFORMA DE RESOLUCIÓN DE CONFLICTOS</h3>
        <p class="colorFuenteWebInfo2">Por si puede ser de tu interés, para someter tus reclamaciones puedes utilizar también la plataforma de resolución de litigios que facilita la Comisión Europea y que se encuentra disponible en el<a target="_blank" href="http://ec.europa.eu/consumers/odr/"> siguiente enlace</a>.</p>

        <h3 class="colorFuenteWebInfo1">DERECHOS DE PROPIEDAD INTELECTUAL E INDUSTRIAL</h3>
        <p class="colorFuenteWebInfo2">En virtud de lo dispuesto en los artículos 8 y 32.1, párrafo segundo, de la Ley de Propiedad Intelectual, quedan expresamente prohibidas la reproducción, la distribución y la comunicación pública, incluida su modalidad de puesta a disposición, de la totalidad o parte de los contenidos de esta página web, con fines comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de TransferDavid. El usuario se compromete a respetar los derechos de Propiedad Intelectual e Industrial titularidad de .
    ...
    Datos personales del interesado titular de los derechos presuntamente infringidos, o indicar la representación con la que actúa en caso de que la reclamación la presente un tercero distinto del interesado.
        ...
        <h3 class="colorFuenteWebInfo1">ENLACES EXTERNOS</h3>
    ...
    La Información que se proporcione en estos Sitios patrocinado o enlaces de afiliados está sujeta a las políticas de privacidad que se utilicen en dichos Sitios y no estará sujeta a esta política de privacidad. Por lo que recomendamos ampliamente a los Usuarios a revisar detalladamente las políticas de privacidad de los enlaces de afiliado.
        ...
        <h3 class="colorFuenteWebInfo1">POLÍTICA DE COMENTARIOS</h3>
    ...
    Se desestimará, igualmente, aquellos comentarios creados sólo con fines promocionales de una web, persona o colectivo y todo lo que pueda ser considerado spam en general.
        ...
        <h3 class="colorFuenteWebInfo1">EXCLUSIÓN DE GARANTÍAS Y RESPONSABILIDAD</h3>
        <p class="colorFuenteWebInfo2">El Prestador no otorga ninguna garantía ni se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran traer causa de:
    ...
    La falta de licitud, calidad, fiabilidad, utilidad y disponibilidad de los servicios prestados por terceros y puestos a disposición de los usuarios en el sitio web.
        ...
        <h3 class="colorFuenteWebInfo1">LEY APLICABLE Y JURISDICCIÓN</h3>
        <p class="colorFuenteWebInfo2">Con carácter general las relaciones entre con los Usuarios de sus servicios telemáticos, presentes en esta web se encuentran sometidas a la legislación y jurisdicción españolas y a los tribunales.</p>

        <h3 class="colorFuenteWebInfo1">CONTACTO</h3>
        <p class="colorFuenteWebInfo2">En caso de que cualquier Usuario tuviese alguna duda acerca de estas Condiciones legales o cualquier comentario sobre el portal, por favor diríjase al correo transferdavid@hotmail.com.</p>

        <p class="colorFuenteWebInfo2">De parte del equipo que formamos Transferdavid te agradecemos el tiempo dedicado en leer este Aviso Legal.</p>
    </div>
    @endsection